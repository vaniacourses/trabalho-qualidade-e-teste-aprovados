...
| 5.4.4 | Rafael | `ContaCorrente` | Mutation coverage: `14%` | Testes para compra debito/credito, confirmacao/cancelamento, taxa, fatura e integracao com cartao | Mutation coverage: `100%` | `>= 80%` | Atingida |
...
| `ContaCorrente` | 27% (11/41) | 100% (35/35) | 14% (4/28) | 100% (26/26) | 80% (4/5) | 100% (26/26) |
...
| Mutation coverage | 93% (142/153) |
| Test strength | 93% (142/152) |
